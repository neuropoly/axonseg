...
path1 = uigetimagefile;
f = im2double(imread(path1));

path2 = uigetimagefile;
g = im2double(imread(path2));
...
[output, result] = dftregistration(fft2(f),fft2(g),100);
display(output),
%% 
