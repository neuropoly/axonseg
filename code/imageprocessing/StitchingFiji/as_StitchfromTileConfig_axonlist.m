function [axonlist, RowPos, ColPos, matrixsize, PixelSize] = as_StitchfromTileConfig_axonlist(fname,nodata)
...
matrixsize = [(max(RowPos) + size(img,1)) (max(ColPos) + size(img,2))];
axonlist = as_listcell2axonlist(axonlist,[RowPos ColPos],0,PixelSize);

%save('./axonlist_full_image_panorama.mat', 'axonlist', 'matrixsize', 'PixelSize','-v7.3')
